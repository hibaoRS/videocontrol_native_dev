#ifndef LVGL_STRING_UTILS_H
#define LVGL_STRING_UTILS_H
...
public:
    ...
    */
    ...
    Split(const std::string &input, const std::string &delimiter, unsigned int iMaxStrings = 0);
    ...
    static long int StrToLongInt(const std::string &str);
    static long int StrToLongInt(const char *s);
